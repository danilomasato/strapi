  ...
  config: {
    ...
    translations: {
      "pt-BR": {
          ...
          "Auth.form.welcome.title": "Bem-vindo(aa)",
          ...
          "Auth.form.button.go-home": "VOLTAR PRO INÍCIO",
          ...
          "Auth.form.welcome.subtitle": "Entra na sua conta do Strapi",
          ...
          "Role": "Papel",
          "Roles & Permissions": "Papéis & Permissões",
          "Roles.ListPage.notification.delete-all-not-allowed": "Alguns papéis não puderam ser removidos por estarem associados a alguns usuários",
          "Roles.ListPage.notification.delete-not-allowed": "O papel não pode ser removido se ainda estiver associado a algum usuário",
          "Roles.RoleRow.select-all": "Selecione {name} para ações em massa",
          "Roles.components.List.empty.withSearch": "Não existe um papel correspondente à busca ({search})...",
          ...
          "Settings.apiTokens.copy.editMessage": "Por motivos de segurança, você só poderá ver sua chave uma única vez.",
          "Settings.apiTokens.copy.editTitle": "Essa chave não está mais acessível.",
          "Settings.apiTokens.copy.lastWarning": "Certifique-se de copiar esta chave, pois não será possível vê-la novamente!",
          ...
          "Settings.apiTokens.notification.copied": "Chave copiada pra área de transferência.",
          "Settings.apiTokens.title": "Chaves de API",
          "Settings.apiTokens.types.full-access": "Acesso total",
          "Settings.apiTokens.types.read-only": "Somente leitura",
          ...
          "Settings.roles.create.title": "Criar um papel",
          "Settings.roles.created": "Papel criado",
          "Settings.roles.edit.title": "Editar um papel",
          "Settings.roles.form.button.users-with-role": "{number, plural, =0 {# usuários} one {# usuário} other {# usuários}} com esse papel",
          "Settings.roles.form.created": "Criado",
          "Settings.roles.form.description": "Nome e descrição do papel",
          ...
          "Settings.roles.title.singular": "papel",
          ...
          "Settings.sso.form.defaultRole.label": "Papel padrão",
          ...
          "app.components.UpgradePlanModal.button": "Aprender mais",
          ...
          "components.FilterOptions.FILTER_TYPES.$contains": "contém (diferencia maiúsculas e minúsculas)",
          ...
          "components.FilterOptions.FILTER_TYPES.$notContains": "não contém (diferencia maiúsculas e minúsculas)",
          ...
          "content-manager.DynamicTable.relation-loaded": "Os relacionamentos foram carregados",
          ...
          "content-manager.components.DynamicTable.row-line": "item {number}",
          ...
          "content-manager.popUpWarning.bodyMessage.contentType.delete": "Tem a certeza de que deseja remover este registro?",
          "content-manager.popUpWarning.bodyMessage.contentType.delete.all": "Tem a certeza de que deseja remover estes registros?",
          "content-manager.popUpWarning.warning.cancelAllSettings": "Você tem certeza de que deseja cancelar suas modificações?",
          "content-manager.popUpWarning.warning.publish-question": "Você ainda quer publicar esse conteúdo?",
          "content-manager.popUpWarning.warning.unpublish": "Despublicar esse conteúdo automaticamente<br></br>fará com que ele volte a ser um rascunho.",
          "content-manager.popUpWarning.warning.unpublish-question": "Tem certeza que deseja despublicar esse conteúdo?",
          "content-manager.popUpWarning.warning.updateAllSettings": "Isto irá modificar todas as suas configurações",
