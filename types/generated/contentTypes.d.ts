...
export interface ApiAnuncioAnuncio extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    modalidade: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Andar: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    Ano_Construcao: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    anuncio: Schema.Attribute.Relation<'manyToOne', 'api::anuncio.anuncio'>;
    ...
    Banheiros: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    cidade: Schema.Attribute.Relation<'manyToOne', 'api::category.category'>;
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    Quartos: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    imoveis: Schema.Attribute.Relation<'oneToOne', 'api::article.article'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::author.author'
